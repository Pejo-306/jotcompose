...
/**
 * Generate a deterministic, fixed-length Base62 note ID.
 *
 ...
 * @returns {string} Base62 ID prefixed with "n".
 */
function generateNoteId(counter, length = 7, salt = "default_salt", mult = 1315423911) {
